...
export default function ProfileView({ onLogout, onManageSubscription, onSupportClick }) {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-brand-cream dark:bg-brand-dark overflow-y-auto no-scrollbar pb-24">
            <div className="flex items-center justify-between p-4 pt-6 bg-brand-cream dark:bg-[#2d2418] sticky top-0 z-20 border-b border-gray-100 dark:border-gray-800">
                <h2 className="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] ml-2">Profile & Settings</h2>
            ...
            <div className="px-4 mb-6">
                <div className="bg-white dark:bg-[#2d2418] rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden group">
