        ...
        <div className="flex flex-col h-full w-full bg-brand-cream dark:bg-brand-dark pb-24">
            ...
            <main className="flex-1 px-4 py-6 space-y-8">
                ...
                <section className="space-y-4">
                    <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Past Orders</h2>
                    ...
                    {orders.length === 0 ? (
                        ...
                        orders.map(order => (
                            <div key={order.id} className="group relative flex flex-col gap-4 rounded-xl bg-white dark:bg-[#2d2418] p-4 shadow-sm border border-gray-100 dark:border-gray-800">
